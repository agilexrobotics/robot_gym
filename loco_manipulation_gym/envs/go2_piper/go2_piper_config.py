...
import numpy as np
class Go2PiperRoughCfg( LeggedRobotCfg ):
    ...
    class asset( LeggedRobotCfg.asset ):
        file = '{LOCO_MANI_GYM_ROOT_DIR}/resources/robots/go2_piper/urdf/go2_piper.urdf'
        name = "go2_piper"
        foot_name = "foot"
        arm_link_name = ["arm"]
    ...
    class normalization(LeggedRobotCfg.normalization):
        ...
        clip_actions = 100.
class Go2PiperRoughCfgPPO( LeggedRobotCfgPPO ):
    class algorithm( LeggedRobotCfgPPO.algorithm ):
        entropy_coef = 0.01
    class runner( LeggedRobotCfgPPO.runner ):
        run_name = ''
        experiment_name = 'go2_piper'
