...
import numpy as np
class AirbotPiperRoughCfg( LeggedRobotCfg ):
    ...
    class asset( LeggedRobotCfg.asset ):
        file = '{LOCO_MANI_GYM_ROOT_DIR}/resources/robots/airbot_piper/urdf/airbot_piper.urdf'
        name = "airbot_piper"
    ...
    class normalization(LeggedRobotCfg.normalization):
        ...
        clip_actions = 100.
class AirbotPiperRoughCfgPPO( LeggedRobotCfgPPO ):
    seed = 21
